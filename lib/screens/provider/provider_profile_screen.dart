...
class _ProviderProfileScreenState extends State<ProviderProfileScreen> {
  ...
  // Helper method for case-insensitive status matching
  bool _matchesStatus(Booking booking, List<String> statuses) {
    final bookingStatus = booking.status.toLowerCase();
    return statuses.any((s) => s.toLowerCase() == bookingStatus);
  }
            ...
            SliverPadding(
              ...
              sliver: SliverList(
                delegate: SliverChildListDelegate([
                  ...
                  // Statistics Card for Requests and Bookings
                  StreamBuilder<List<Booking>>(
                    stream: _currentUser != null
                        ? _dbService.getProviderBookings(_currentUser!.id)
                    ...
                    builder: (context, snapshot) {
                      ...
                      final accepted = bookings
                          .where(
                            (b) => _matchesStatus(b, ['Accepted', 'accepted']),
                          )
                          .length;
